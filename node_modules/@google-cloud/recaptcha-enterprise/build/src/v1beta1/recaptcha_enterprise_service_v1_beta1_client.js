...
class RecaptchaEnterpriseServiceV1Beta1Client {
    ...
    initialize() {
        ...
        this.recaptchaEnterpriseServiceV1Beta1Stub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.recaptchaenterprise.v1beta1.RecaptchaEnterpriseServiceV1Beta1, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const recaptchaEnterpriseServiceV1Beta1StubMethods = ['createAssessment', 'annotateAssessment'];
