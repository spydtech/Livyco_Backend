...
class RecaptchaEnterpriseServiceClient {
    ...
    initialize() {
        ...
        this.recaptchaEnterpriseServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.recaptchaenterprise.v1.RecaptchaEnterpriseService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const recaptchaEnterpriseServiceStubMethods = ['createAssessment', 'annotateAssessment', 'createKey', 'listKeys', 'retrieveLegacySecretKey', 'getKey', 'updateKey', 'deleteKey', 'migrateKey', 'addIpOverride', 'removeIpOverride', 'listIpOverrides', 'getMetrics', 'createFirewallPolicy', 'listFirewallPolicies', 'getFirewallPolicy', 'updateFirewallPolicy', 'deleteFirewallPolicy', 'reorderFirewallPolicies', 'listRelatedAccountGroups', 'listRelatedAccountGroupMemberships', 'searchRelatedAccountGroupMemberships'];
